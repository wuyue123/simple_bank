...
type UpdateUserRequest struct {
	...
	FullName      *string                `protobuf:"bytes,3,opt,name=full_name,json=fullName,proto3,oneof" json:"full_name,omitempty"` //全名
...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB\x1bZ\x19pxsemic.com/simplebank/pbb\x06proto3"
